<?php
namespace Wachimbo\Banners\Block;
class Products extends \Magento\Catalog\Block\Product\NewProduct
{
    /**
    ...
    public function getProductCollectionByCategories($ids, $size)
    {
        $collection = $this->_productCollectionFactory->create();
